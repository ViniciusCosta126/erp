<x-app title="Produtos">
    @section('title-page')
        <div class="flex items-center gap-6">
            <x-common.head-title titulo="Criar um novo produto" descricao="Use esta pagina para criar novos Produtos" />
        </div>
    @endsection
                    ...
                    <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-6">
                        ...
                        <div class="md:col-span-3">
                            ...
                            <input type="number" name="preco" id="preco"
                                class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="{{ old('preco') }}"
                                placeholder="Preço de venda do produto" step="0.01" />
                        </div>
                        <div class="md:col-span-3">
                            <label for="preco_custo">Preço de Custo</label>
                            <input type="number" name="preco_custo" id="preco_custo"
                                class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="{{ old('preco_custo') }}"
                                placeholder="Preço de custo do produto" step="0.01" />
                        </div>
                        <div class="md:col-span-3">
                            <label for="quantidade_estoque">Quantiade em estoque</label>
                            <input type="number" name="quantidade_estoque" id="quantidade_estoque"
                                class="h-10 border mt-1 rounded px-4 w-full bg-gray-50"
                                value="{{ old('quantidade_estoque') }}" placeholder="Preço de custo do produto" />
                        </div>
                        <div class="md:col-span-3">
                            ...
                            <input type="number" name="quantidade_minima_estoque" id="quantidade_minima_estoque"
                                class="h-10 border mt-1 rounded px-4 w-full bg-gray-50"
                                value="{{ old('quantidade_minima_estoque') }}"
